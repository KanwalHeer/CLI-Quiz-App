...
let QuizData = JSON.parse(fs.readFileSync("q.json", "utf-8"));
let scor = 0;
let userName = "";
...
async function presentQuestion(questionNumber, question) {
...
function displayScore() {
    console.log(chalk.magenta.bold.italic(` Dear ${chalk.cyan.bold.italic(userName)} Your final scor is :${scor} out of ${QuizData.length}`));
}
mainFunction();
